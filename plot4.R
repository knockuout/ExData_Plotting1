...
# # Create chart Plot1 chart (basic histo rojo)
# hist(df$Global_active_power, main = paste("Global Active Power"), col = "red", 
#      xlab = "Global Active Power (kilowatts)")
# dev.copy(png, file = "plot1.png", width = 480, height = 480)
# dev.off()
# # Create Plot2 chart  (basic lines)
# plot(df$timestamp, df$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
# dev.copy(png, file = "plot2.png", width = 480, height = 480)
# dev.off()
# Create Plot3 chart (w/ line layers)
# if using RStudio make sure to make Plots screen roughly 480X480 so dev copy work prettier
